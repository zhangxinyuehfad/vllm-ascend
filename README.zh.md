...
- [2026/09] 我们发布了新的候选版本 [v0.27.1rc1](https://github.com/vllm-project/vllm-ascend/releases/tag/v0.27.1rc1)! 请按照[官方指南](https://docs.vllm.ai/projects/ascend/en/v0.27.1rc1/)开始在 Ascend 上部署 vLLM Ascend Plugin。
...
|------------|--------------|--------------------------------------|
| v0.27.1rc1 | 候选版本 | 请查看[快速开始](https://docs.vllm.ai/projects/ascend/en/v0.27.1rc1/quick_start.html)和[安装指南](https://docs.vllm.ai/projects/ascend/en/v0.27.1rc1/installation.html)了解更多 |
