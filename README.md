...
- [2026/07] We released the first release candidate [v0.24.0rc1](https://github.com/vllm-project/vllm-ascend/releases/tag/v0.24.0rc1)! Please follow the [official guide](https://docs.vllm.ai/projects/ascend/en/v0.24.0rc1/) to start using vLLM Ascend Plugin on Ascend.
...
|------------|--------------|--------------------------------------|
| v0.24.0rc1 | Latest release candidate | See [QuickStart](https://docs.vllm.ai/projects/ascend/en/v0.24.0rc1/quick_start.html) and [Installation](https://docs.vllm.ai/projects/ascend/en/v0.24.0rc1/installation.html) for more details |
