...
- [2026/09] We released the new release candidate [v0.27.1rc1](https://github.com/vllm-project/vllm-ascend/releases/tag/v0.27.1rc1)! Please follow the [official guide](https://docs.vllm.ai/projects/ascend/en/v0.27.1rc1/) to start using vLLM Ascend Plugin on Ascend.
...
|------------|--------------|--------------------------------------|
| v0.27.1rc1 | Release candidate | See [QuickStart](https://docs.vllm.ai/projects/ascend/en/v0.27.1rc1/quick_start.html) and [Installation](https://docs.vllm.ai/projects/ascend/en/v0.27.1rc1/installation.html) for more details |
